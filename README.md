...
# Інформаційна система для автоматизованого аналізу та візуалізації індикаторів якості ЕКГ

>Вебзастосунок для автоматизованої обробки, аналізу та візуалізації електрокардіографічних сигналів із формуванням PDF-звіту.
---
